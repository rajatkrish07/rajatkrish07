...
- Building **RAG pipelines** using LangChain, LangGraph & vector databases (ChromaDB, FAISS)
- Developing **FastAPI-based** backend services with Pydantic & SQLAlchemy
- Writing **REST APIs** backed by PostgreSQL
- Testing workflows with **Pytest** and **Postman**
- Exploring **LLM-powered applications** and prompt engineering techniques
